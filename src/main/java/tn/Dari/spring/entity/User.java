...
public class User implements Serializable {
	...
	public User(long userId, long cin, String name, String address, String email, String numTel, String sex,
	...
	public String toString() {
		return "User [userId=" + userId + ", cin=" + cin + ", name=" + name + ", address=" + address + ", email="
				+ email + ", numTel=" + numTel + ", sex=" + sex + ", verificationCode=" + verificationCode
